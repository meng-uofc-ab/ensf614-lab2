...
public:
  ...
  bool operator >= (const Mystring& rhs) const; // greater than or equal operator
  // REQUIRES: rhs is reference to a Mystring object as a source
  // PROMISES: compares the Mystring object with this-object (object that this is pointing to)
  // returns 1 if this object is greater than or equal to rhs, else returns 0

  bool operator <= (const Mystring& rhs) const; // less than or equal operator
  // REQUIRES: rhs is reference to a Mystring object as a source
  // PROMISES: compares the Mystring object with this-object (object that this is pointing to) and
  // returns 1 if this object is less than or equal to rhs, else returns 0
    
  bool operator != (const Mystring& rhs) const; // not equal to operator
  // REQUIRES: rhs is reference to a Mystring object as a source
  // PROMISES: compares the Mystring object with this-object (object that this is pointing to)
  // returns 1 if this object is not equal to rhs, else returns 0
    
  bool operator == (const Mystring& rhs) const; // equal to operator
  // REQUIRES: rhs is reference to a Mystring object as a source
  // PROMISES: compares the Mystring object with this-object (object that this is pointing to)
  // returns 1 if this object is equal to rhs, else returns 0

  bool operator > (const Mystring& rhs) const; // greater than operator
  // REQUIRES: rhs is reference to a Mystring object as a source
  // PROMISES: compares the Mystring object with this-object (object that this is pointing to) and
  // returns 1 if this object is greater than rhs, else returns 0
  
  bool operator < (const Mystring& rhs) const; // less than operator
  // REQUIRES: rhs is reference to a Mystring object as a source
  // PROMISES: compares the Mystring object with this-object (object that this is pointing to) and
  // returns 1 if this object is less than rhs, else returns 0
    
  char& operator [] (int index) const; // subscript operator
  // REQUIRES: index of the element
  // PROMISES: returns character at the position specified by the index
